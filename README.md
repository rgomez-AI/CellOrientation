...
|-----------------|---------------------------------|---------------------------------------------------------|
| lif2tif         | lif2tif.sh                      | Open .lif file series and convert <br> them into .TiF <br> |
| split_channels  | lif2tif_split_proj_headless.ijm | Z project stack (Standard Deviation) <br> and Split channels |     
...
Sample dataset provided by [Jennifer Jungfleisch](https://orcid.org/0000-0003-1063-9556) from [Fatima Gebauer](https://orcid.org/0000-0001-7563-0013) Lab are images of human melanoma cells: [download](https://public-docs.crg.es/almu/rgomez/Jennifer_Jungfleisch/Dataset.zip)
